...
#'    \describe{
#'       \item{\code{node}}{
#'         \emph{Tracing job}. Identifier of the node which regime parameters is calculated for. Values in this vector are identical to those in argument \code{acceptor}. Type: \code{\link{assert_character}}.
#'       }
#'       \item{\code{tracing}}{
#'         \emph{Tracing job}. Identifiers of nodes from which regime parameters are traced for the given node. Identifier \code{sensor} is used when
#'         values of regime parameters for the node are sensor readings. Type: \code{\link{assert_character}}.
#'       }
#'       \item{\code{backward}}{
#'          \emph{Tracing job}. Identifier of tracing direction. It constantly equals to \code{TRUE}. Type: \code{\link{assert_logical}}.
#'        }
...
#'        }
#'       \item{\code{Q}}{
#'          \emph{Traced thermal hydraulic regime}. Normative heat loss of adjacent pipe per day, [\emph{kcal}]. Type: \code{\link{assert_double}}.
#'        }
#'       \item{\code{temperature}}{
#'          \emph{Traced thermal hydraulic regime}. Traced temperature of heat
#'          carrier (water) that is associated with the node, [\emph{°C}]. Type: \code{\link{assert_double}}.
#'        }
#'       \item{\code{pressure}}{
#'          \emph{Traced thermal hydraulic regime}. Traced pressure of heat
#'          carrier (water) that is associated with the node, [\emph{MPa}]. Type: \code{\link{assert_double}}.
#'        }
#'       \item{\code{flow_rate}}{
#'          \emph{Traced thermal hydraulic regime}. Traced flow rate of heat
#'           carrier (water) that is associated with the node, [\emph{ton/hour}]. Type: \code{\link{assert_double}}.
#'        }
#'       \item{\code{job}}{
#'          \emph{Tracing job}. Value of tracing job counter. Type: \code{\link{assert_count}}.
#'        }
#'    }
...
#' output_mean <- do.call(
#'   "m325tracebw", c(as.list(nx), verbose = FALSE, opinion = "mean")
#' )
#'
#' ## * When aggregation is by median:
#' output_median <- do.call(
#'   "m325tracebw", c(as.list(nx), verbose = FALSE, opinion = "median")
#' )
#'
...
#' output <- do.call("m325tracebw", c(as.list(nx)))
#' print(output)
#'
#' @export
