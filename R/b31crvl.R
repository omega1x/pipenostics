...
#'
#' @param maop
#'  maximum allowable operating pressure - \emph{MAOP}, [\emph{PSI}]. Type: \code{\link[checkmate]{assert_double}}.
#'
#' @param d
...
#'  characteristics of steel strength, [\emph{PSI}]. Type: \code{\link[checkmate]{assert_double}}.
#'
#' @param def
...
#'
#'  \describe{
#'   \item{maop}{maximum allowable operating pressure - \emph{MAOP}, [\emph{PSI}]. Type: \code{\link[checkmate]{assert_double}}.}
#'   \item{d}{nominal outside diameter of pipe, [\emph{inch}]. Type: \code{\link[checkmate]{assert_double}}.}
#'   \item{wth}{nominal wall thickness of pipe, [\emph{inch}]. Type: \code{\link[checkmate]{assert_double}}.}
...
#'              or \href{https://www.asme.org/codes-standards/find-codes-standards/b31-11-slurry-transportation-piping-systems}{ASME B31.11}, [].
#'              Type: \code{\link[checkmate]{assert_double}}.}
#'   \item{depth}{measured maximum depth of the corroded area, [\emph{inch}]. Type: \code{\link[checkmate]{assert_double}}.}
#'   \item{l}{measured maximum longitudial length of corroded area, [\emph{inch}]. Type: \code{\link[checkmate]{assert_double}}.}
...
#'   \item{design_pressure}{design pressure of pipe, [\emph{PSI}]. Type: \code{\link[checkmate]{assert_double}}.}
#'   \item{safe_pressure}{safe maximum pressure for the corroded area, [\emph{PSI}]. Type: \code{\link[checkmate]{assert_double}}.}
#'   \item{pressure_exceeding}{whether operator's action is required to reduce
#'                             \emph{MOAP} lower than the maximum safe pressure
#'                             of the corroded area. Type: \code{\link[checkmate]{assert_logical}}.}
#'   \item{allowed_corrosion_depth}{allowable depth of the corroded area, [\emph{inch}]. Type: \code{\link[checkmate]{assert_double}}.}
#'   \item{A}{intermediate factor related to the geometry of the corroded area, []. Type: \code{\link[checkmate]{assert_double}}.}
#'   \item{allowed_corrosion_length}{allowable length of the corroded area, [\emph{inch}]. Type: \code{\link[checkmate]{assert_double}}.}
#'   \item{AP}{another intermediate factor related to the geometry of the corroded area, []. Type: \code{\link[checkmate]{assert_double}}.}
#'  }
#'
#' @details
