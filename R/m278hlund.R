#' @title
#'  Minenergo-278. Calculate heat losses of underground pipeline segment
#'
#'
#' @family Minenergo
#'
...
#' @param z
#'   underground laying depth, [\emph{m}], numeric vector.
#' @param s
#'   distance between supplying and returning types, [\emph{m}], numeric vector.
#' @param len
