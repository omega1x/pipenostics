...
#
# @description
#   Check if a geographical location is inside the triangle formed by three
#   another objects on a map
#
# @param lat
...
geointri <- function(
  lat, lon, lat1, lon1, lat2, lon2, lat3, lon3, earth = 6371008.7714
) {
  ...
  TOLERANCE  <- 1e-6  # precision up to [m²]
