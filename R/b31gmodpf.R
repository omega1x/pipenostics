...
#'  \emph{Modified B31G},\emph{Level-1} algorithm listed in
...
#'
#'  The \eqn{d_{\text{cor}}} value depicted in the figure above is represented
#'  by argument \code{depth}.
#'
#' @details
...
#'   maximum affinity with its semantic description in
# nolint start: line_length_linter.
#'   \href{https://www.asme.org/codes-standards/find-codes-standards/b31g-manual-determining-remaining-strength-corroded-pipelines}{
# nolint end
#'    ASME B31G-2012}.
...
#'    \item
# nolint start: line_length_linter.
#'      \href{https://www.asme.org/getmedia/7336b61b-5762-47ca-bdcb-8a4e0de6f162/33501.pdf}{
# nolint end
...
#'
#'    \item
#'      S. Timashev and A. Bushinskaya, \emph{Diagnostics and Reliability
