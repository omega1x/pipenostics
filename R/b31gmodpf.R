...
#'
#' @param l
#'  measured maximum longitudinal length of corroded area, [\emph{inch}]. Type: \code{\link[checkmate]{assert_double}}.
#'
#' @return
#'  Estimated failure pressure of the corroded pipe, [\emph{PSI}]. Type: \code{\link[checkmate]{assert_double}}.
#'
#' @references
#'  \enumerate{
