...
#'  fracture toughness, and on the high-precision modelling of the finite
#'  element pipe models performed at the \emph{Battelle Institute}. According to
#'  field test results of a large number of actual pipe segments, the
#'  destruction mechanism for defective pipeline segment depends on the pipe
#'  material fracture toughness. These tests also showed that only pipes made
#'  out of steel with improved or high fracture toughness fail a result of
#'  plastic fracture. In determining the \emph{Folias} factor the effect of
#'  increased stress concentration and steel hardening in the plastic
#'  deformation zone at the start of the defect failure process was taken into
#'  account.
#'
...
#'          of pipe material ductile–brittle transition, and for pipe material
...
#'          Quality 30, \doi{10.1007/978-3-319-25307-7}.
#'
...
#'          \doi{10.1016/j.matpr.2017.07.081}.
#'  }
#'
#' @export
#'
