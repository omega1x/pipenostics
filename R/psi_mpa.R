...
#'  to \href{https://en.wikipedia.org/wiki/Pounds_per_square_inch}{pounds per
#'   square inch} (PSI)
#'
#' @param x
...
#'  [\emph{PSI}]. Type: \code{\link[checkmate]{assert_double}}.
#'
#' @seealso
#'  \code{\link{mpa_psi}} for converting \emph{pounds per square inch} to
#'  \emph{megapascals}
#'
#' @export
#'
