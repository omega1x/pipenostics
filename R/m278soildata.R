...
#' \describe{
#'   \item{subsoil}{Geological name of subsoil. Type: \code{\link[checkmate]{assert_character}}.}
#'   \item{state}{The degree of water penetration to the subsoil. Type: \code{\link[checkmate]{assert_character}}.}
