...
#'  characteristic of steel strength, [\emph{MPa}]. Type: \code{\link[checkmate]{assert_double}}.
#'
#' @param depth
#'  measured maximum depth of the corroded area, [\emph{mm}]. Type: \code{\link[checkmate]{assert_double}}.
#'
#' @param l
#'  measured maximum longitudinal length of corroded area, [\emph{mm}]. Type: \code{\link[checkmate]{assert_double}}.
#'
#' @return
