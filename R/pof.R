...
#'
#'  \describe{
#'     \item{\emph{rupture}}{a decrease of the value of failure pressure down to the
#'     operating pressure.}
#'     \item{\emph{leak}}{increase of the corrosion depth (defect) up to the specified
#'     ultimate permissible fraction of pipe wall thickness.}
#'  }
#'
#'  They also assume change in depth and length of corrosion defects in time be
#'  close to linear.
#'
#' @details
#'    Unlike
