...
test_that("*dropg* errs in flow rate drop", {
  ...
  adjp <- list(
    # diameters of 4 discharge pipes and 2 recharge pipes, [mm]:
    c(100, 175, 175, -65, 125, -60),

    # diameter of 1 discharge pipe and 4 recharge pipes, [mm]:
    c(-300, -100, -65, 125, -60),

    # diameter of 1 discharge pipe, [mm]:
    c(950),

    # diameter of 1 recharge pipe, [mm]:
    c(-255),
